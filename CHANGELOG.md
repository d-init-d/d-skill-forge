...
- Example corpus: `sql-debug` (10 tasks covering common SQL bugs)
- Example corpus: `regex-puzzles` (10 tasks covering regex patterns)
- Docs pages for both new examples
- mkdocs nav expanded with new example pages
